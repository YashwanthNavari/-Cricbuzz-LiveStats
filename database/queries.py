...
LIMIT 15;
        ...
        "params": {},
        "chart_type": "scatter",
        "chart_kwargs": {"x": "Balls Faced", "y": "Strike Rate", "text": "Player Name", "size": "Total Runs"}
    },
    "Q5": {
...
LIMIT 5;
        ...
        "params": {},
        "chart_type": "bar",
        "chart_kwargs": {"x": "Partnership Runs", "y": "Match Details", "orientation": "h"}
    },
    "Q8": {
...
LIMIT 10;
        ...
        "params": {},
        "chart_type": "bar",
        "chart_kwargs": {"x": "Total Runs", "y": "Batsman 1", "color": "Batsman 2", "orientation": "h"}
    },
    "Q22": {
...
LIMIT 15;
        ...
        "params": {},
        "chart_type": "bar",
        "chart_kwargs": {"x": "Extras Ratio (%)", "y": "Match", "color": "Bowling Team", "orientation": "h"}
    },
    "Q24": {
